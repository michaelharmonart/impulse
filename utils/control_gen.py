...
def generate_control(
    ...
    if control_shape == ControlShape.CIRCLE:
        #this is directly copy and pasted from a MEL command to create a curve, 
        #or from a ctrl file from a tool such as http://morganloomis.com/tool/ml_controlLibrary/
        MEL_string: str = """//ML Control Curve: circle
		...
		;"""
        mel.eval(MEL_string)
    if control_shape == ControlShape.TRIANGLE:
        #this is directly copy and pasted from a MEL command to create a curve, 
        #or from a ctrl file from a tool such as http://morganloomis.com/tool/ml_controlLibrary/
        MEL_string: str = """//ML Control Curve: triangle
		...
		;"""
        mel.eval(MEL_string)
    if control_shape == ControlShape.PILL:
        #this is directly copy and pasted from a MEL command to create a curve, 
        #or from a ctrl file from a tool such as http://morganloomis.com/tool/ml_controlLibrary/
        MEL_string: str = """//ML Control Curve: pill
		...
		;"""
        mel.eval(MEL_string)
    if control_shape == ControlShape.SQUARE:
        #this is directly copy and pasted from a MEL command to create a curve, 
        #or from a ctrl file from a tool such as http://morganloomis.com/tool/ml_controlLibrary/
        ...
        ;"""
        mel.eval(MEL_string)
    ctl: str = cmds.listRelatives(cmds.ls(selection=True)[0], parent=True)
    cmds.select(ctl)
